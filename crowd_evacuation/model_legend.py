    ...
    def render(self, model):
        legend = '''
         <fieldset>
          ...
          <div><div style='float: left;height: 20px;width: 20px;margin-bottom: 15px;margin-right: 10px;border: 1px solid black;clear: both;background-color:Cyan'></div> <p style="font-size:16px; margin-bottom: 15px">Agent aged <= 30 </p> </div>
          ...
          <div><div style='float: left;height: 20px;width: 20px;margin-bottom: 15px;margin-right: 10px;border: 1px solid black;clear: both;background-color:DarkBlue'></div> <p style="font-size:16px; margin-bottom: 15px"> Agent aged <= 65 </p> </div>
